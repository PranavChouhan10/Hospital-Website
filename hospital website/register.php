...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    {
        $db_urs_name = "select * from users where user_name ='$User_name'";
        ...
        else
        {
            ...
            $query = "insert into users (User_id,User_name,fulll_name,email,Password,dob,gender) values('$User_id','$User_name','$fulll_name','$email','$Password','$dob','$gender')";
...
<head>
    ...
    <title>Create Your Account | Medcare...
    </title>
...
<body>
    <div class="main">
        ...
        <form name="regform" action="" method="post">
            Username*
            <br>
            <input name="uname" type="name" placeholder="Enter your username" required minlength="4" maxlength="16" name="username" value="">
            <br>
            Name*
            <br>
            <input name="name" type="name" placeholder="Enter your username" required minlength="0" maxlength="30" name="username" value="">
            <br>
            Email*
            <br>
